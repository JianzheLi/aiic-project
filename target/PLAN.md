...
1. 用户先选择训练入口：八股知识点、简历经历、手撕代码。
2. 八股模式选择知识分类；简历模式上传 PDF/DOCX/TXT 简历或粘贴文本；手撕代码模式选择 LeetCode 高频题或 AI 算子题。
3. AI 面试官按对应训练目标连续追问。
4. 用户用文字作答。
...
- [x] 新增 `/training/message`，统一支持 `knowledge`、`resume`、`coding` 三种训练模式。
- [x] 改造前端为三入口训练首页和三个独立训练界面。
